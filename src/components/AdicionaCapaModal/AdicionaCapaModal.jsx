        ...
        <Modal closeModal={closeModal}>
            <div className="AdicionaCapaModal">
                <form autoComplete="off">
                    <h2> { ActionMode.ATUALIZAR === mode ? 'Atualizar' : 'Adicionar à' } lista </h2>
                    <div>
                        <label className="AdicionaCapaModal__text" htmlFor="ano"> ano: </label>
                        <input
                            id="ano"
                            placeholder="1980"
                            type="text"
                    ...
                    <div>
                        <label className="AdicionaCapaModal__text" htmlFor="album"> Album: </label>
                        <input
                            id="Album"
                    ...
                    <div>
                        <label className="AdicionaCapaModal__text" htmlFor="artista"> artista: </label>
                        <input
                            id="artista"
                    ...
                    <div>
                        <label className="AdicionaCapaModal__text" htmlFor="descricao"> Descricao: </label>
                        <input
                            id="descricao"
                    ...
                    <div>
                        <label className="AdicionaCapaModal__text  AdicionaCapaModal__fotoUrl-label" htmlFor="fotoUrl" >
